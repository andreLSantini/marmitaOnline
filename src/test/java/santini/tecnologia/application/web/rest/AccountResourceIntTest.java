package santini.tecnologia.application.web.rest;

import santini.tecnologia.application.config.Constants;
import santini.tecnologia.application.MarmitaOnlineApp;
import santini.tecnologia.application.domain.Authority;
import santini.tecnologia.application.domain.User;
import santini.tecnologia.application.repository.AuthorityRepository;
import santini.tecnologia.application.repository.UserRepository;
import santini.tecnologia.application.security.AuthoritiesConstants;
import santini.tecnologia.application.service.MailService;
import santini.tecnologia.application.service.dto.UserDTO;
import santini.tecnologia.application.web.rest.errors.ExceptionTranslator;
import santini.tecnologia.application.web.rest.vm.KeyAndPasswordVM;
import santini.tecnologia.application.web.rest.vm.ManagedUserVM;
import santini.tecnologia.application.service.UserService;
...
@SpringBootTest(classes = MarmitaOnlineApp.class)
